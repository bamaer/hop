...
public class GraphRelationshipData {
  ...
  public GraphRelationshipData(IRelationship relationship) {
    this();
    setId(relationship.elementId());
    setSourceNodeId(relationship.startNodeElementId());
    setTargetNodeId(relationship.endNodeElementId());
